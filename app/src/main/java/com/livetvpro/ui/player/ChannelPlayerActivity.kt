...
class ChannelPlayerActivity : AppCompatActivity() {
    ...
    private fun setupPlayer() {
        ...
        // ✅ FIX: Clear error view when setting up new player
        ...
        try {
                        ...
                        override fun onPlaybackStateChanged(playbackState: Int) {
                            when (playbackState) {
                                Player.STATE_READY -> {
                                    ...
                                    binding.progressBar.visibility = View.GONE
                                    binding.errorView.visibility = View.GONE // ✅ Hide error on success
                                    updatePipParams()
            ...
            binding.progressBar.visibility = View.GONE
            binding.errorView.visibility = View.VISIBLE
            binding.errorText.text = "Failed to initialize player: ${e.message}"
    ...
    private fun bindControllerViewsExact() {
        ...
        // ✅ Buttons already have ripple from XML, just ensure clickable
        listOf(
    ...
    private fun switchChannel(newChannel: Channel) {
        // ✅ FIX: Clear error state before switching
        binding.errorView.visibility = View.GONE
        binding.progressBar.visibility = View.VISIBLE
    ...
    override fun onPictureInPictureModeChanged(
        ...
        if (isInPipMode) {
            ...
            // ✅ FIX: Exiting PiP - close activity if not user-requested
            userRequestedPip = false
            
            // If finishing, don't try to restore UI
            if (isFinishing) {
                return
            }
            
            // ✅ FIX: Close activity when exiting PiP (user closed PiP window)
            finish()
        }
    }
    ...
    override fun onUserLeaveHint() {
        ...
        // Auto-enter PiP when user presses home/recents and video is playing
